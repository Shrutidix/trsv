  ...
  return (
    <div className={`flex items-center gap-4 ${className}`}>
      <div className="relative w-24 h-12">
        {/* Sun with rays */}
        <motion.div
          className="absolute top-1.5 left-1/3 transform -translate-x-1/2"
        ...
        >
          ...
          >
            <motion.div
              className="absolute bottom-0.5 w-full h-0.5"
              animate={{ x: [-4, 4, -4] }}
          ...
          >
            <div className="relative w-full h-full">
              ...
              >
                <div className="w-0.5 h-1.5 bg-green-500" style={{ clipPath: 'polygon(50% 0%, 0% 100%, 100% 100%)' }} />
              </motion.div>
              <motion.div
                animate={{ y: [0, -0.5, 0] }}
      ...
      {showText && (
        <div className="flex flex-col items-start">
          ...
          <div className="flex items-center gap-2">
            <motion.div className="w-3 h-0.5 bg-green-500" 
              initial={{ scaleX: 0 }}
              animate={{ scaleX: 1 }}
              transition={{ duration: 0.5 }}
            />
            <motion.p
              className="text-[10px] font-medium text-green-500 tracking-[0.2em]"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              transition={{ duration: 0.5 }}
            >
